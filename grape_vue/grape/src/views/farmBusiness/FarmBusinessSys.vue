                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-button @click="commandHandler('delete', scope.row)" type="text" size="small" v-if="scope.row.editable">删除
                            </el-button>
                            <el-button @click="commandHandler('edit', scope.row)" size="small" type="text" v-if="scope.row.editable">编辑
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
